...
describe('isStockout — stockout dùng nguồn tồn độc lập với sales completeness', () => {
  it('tồn đầu/cuối cùng bằng 0 luôn là ứng viên stockout', () => {
    expect(isStockout({ openStock: 0, closeStock: 0, receiptHour: null })).toBe(true);
  });
