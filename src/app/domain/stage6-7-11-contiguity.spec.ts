...
describe('RULE-06-003 — chuỗi đầu vào ABC phải LIÊN TIẾP, không nối chu kỳ khóa rải rác hai bên khoảng unresolved', () => {
  it('GT-32/34: CK14, CK15, CK25 khóa nhưng CK16-24 unresolved → đoạn liên tiếp gần nhất chỉ có 1 CK (CK25), không đủ 6 → ABC=N/A, tạo task ABC_INPUT_BLOCKED', () => {
  ...
  it('6 chu kỳ khóa liên tiếp ở cuối cửa sổ → được năm hóa (đối chứng: không phải mọi ABC=N/A đều do đứt quãng)', () => {
    const { engine, snapshot } = runTo5();
    const skuId = Object.keys(snapshot.states)[0];
